...
/** 设置像素颜色 */
export function setPixel(buf: PixelBuffer, x: number, y: number, r: number, g: number, b: number, a: number = 255): void {
...
/** 用纯色填充 */
export function fillSolid(buf: PixelBuffer, r: number, g: number, b: number, a: number = 255): void {
...
/** 垂直渐变 */
export function fillGradient(buf: PixelBuffer, r1: number, g1: number, b1: number, r2: number, g2: number, b2: number): void {
...
/** 棋盘格 */
export function fillCheckerboard(buf: PixelBuffer, r1: number, g1: number, b1: number, r2: number, g2: number, b2: number, cellSize: number = 1): void {
  for (let y = 0; y < buf.height; y++) {
